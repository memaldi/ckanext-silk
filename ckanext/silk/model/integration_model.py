...
from sqlalchemy import create_engine, Integer, ForeignKey, Float, Boolean
...
mapper(Transformation, transformation_table, 
    properties={'path_inputs': relationship(PathInput, 
        secondary=transformation_path_inputs_association_table,
        backref='transformations'),
        
    'parameters': relationship(Parameter, 
        backref='transformation', 
        order_by=parameter_table.c.id)
})

mapper(Comparison, comparison_table, 
    properties={'transformations': relationship(Transformation,
        secondary=comparison_transformation_association_table,
        backref='comparisons'),
        
    'path_inputs': relationship(PathInput,
        secondary=comparison_path_input_association_table, 
        backref='comparisons'),
        
    'parameters': relationship(ComparisonParameters,
        backref='comparison',
        order_by=comparison_parameters_table.c.id)
})
