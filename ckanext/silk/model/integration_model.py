...
mapper(Transformation, transformation_table, properties={'path_inputs': relationship(PathInput, secondary=transformation_path_inputs_association_table, backref='transformations', cascade="all, delete, delete-orphan"), 'parameters': relationship(Parameter, backref='transformation', cascade="all, delete, delete-orphan", order_by=parameter_table.c.id)})
mapper(Comparison, comparison_table, properties={'transformations': relationship(Transformation, secondary=comparison_transformation_association_table, backref='comparisons', cascade="all, delete, delete-orphan"), 'path_inputs': relationship(PathInput, secondary=comparison_path_input_association_table, backref='comparisons', cascade="all, delete, delete-orphan"), 'parameters': relationship(ComparisonParameters, backref='comparison', cascade="all, delete, delete-orphan", order_by=comparison_parameters_table.c.id)})
mapper(Restriction, restriction_table, properties={'path_inputs': relationship(PathInput, backref='restriction', cascade="all, delete, delete-orphan", order_by=path_input_table.c.id)})
mapper(LinkageRule, linkage_rule_table, properties={'restrictions': relationship(Restriction, backref='linkage_rule', cascade="all, delete, delete-orphan", order_by=restriction_table.c.id)})
